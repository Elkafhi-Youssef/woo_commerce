...
class Woo_Config {
    ...
    public function dropdown_variation_attribute_options_html_cb(  $old_html,  $args ){
        ...
        $selected_attribute_key_for_auto_convert_to_image = '';
    ...
    public function get_loop_variation_form_html(){
        ...
        if( $is_elementor_preview ){
            return '<div class="elementor-panel"><div class="elementor-panel-alert elementor-panel-alert-warning">'. __( 'Please make sure that are using this shortcode inside product loop/list. Otherwise it worn\'t work.', 'swatchly' ) . '</div></div>';
        }
